...
# Mitochondrial genes have a higher mean and median compared to nuclear genes in the liver. 
...
#Median ignores extreme outliers, which can skew the mean. For mitochondria, although the mean is 11592.72	, the median is 3.40258	 which means that half of the genes are below that expression. This data should probably be normalized to account for that. 
...
# Interpretation here as a comment
# Highly expressed in btoh tissues: MT-CO1, relevant for ATP production in mitochondria, so it makes sense to be highly expressed in the liver. The heart is very energy intensive, so it will very probably need high expression of this gene as well. 
#Low expression in Liver but low in Heart: SAA1 is a dedicated hepatcyte cell, it has no buisness being expressed within the heart. 

#Look up basic information about these genes on the internet. Do their expression patterns make sense given their known functions? 
# It makes sense that both heart and liver have a high expression of MT genes given how energy intensive both tissues are. 
```
...
# interpretation 
#higher tau = higher correlation. The brain has a distinctive expression profile than any other tissue, thus giving it a lower correlation to the Liver when comparing to Liver and Heart. 
```
